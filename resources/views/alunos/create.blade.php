...
@section('breadcrumb')
    @include('layout.dashboard_breadcrumb', ['title' => ['name' => 'Alunos', 'path' => ['Aluno', 'Novo' ]]])
@endsection
...
@section('conteudo')
    ...
    <div class="container-fluid">
        ...
        <!-- ============================================================== -->
        <!-- Row -->
        <form id="form-novo-usuario" class="form-horizontal form-material" action="{{ url('/alunos/store') }}" method="POST" enctype="multipart/form-data"> 
        {{ csrf_field() }}
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body white-box">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="col-md-12 border-bottom p-0">
                                    <input type="text"
                                        class="form-control p-0 border-0" name="nome_mae" required> 
                                </div>
                            </div>
                            <div class="form-group mb-4">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <select class="form-control p-o border-o" name="status">
                                                ...
                                                <option value="2">Pré-Matricula</option>
